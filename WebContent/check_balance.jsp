	...
	<div class="container-fullwidth">
		...
		<div class="row" style="margin-top: 50px;">
			<div class="col-md-4 col-md-offset-4">
				<form role="form" action="CloseAccount" method="POST">
					<h2>Check Balance</h2>
					<div class="col-md-12">
						<hr class="colorgraph">
					</div>
					...
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=ac.getAccount_no() %>" required placeholder=" Account No.."
							class="form-control" disabled>
					</div>
					<label class="col-md-4 control-label">User Name</label>
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=ac.getUsername() %>" required placeholder=" User Name.."
							class="form-control" disabled>
					</div>

					<label class="col-md-4 control-label">Balance Amount</label>
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=ac.getAmount() %>" required placeholder=" Balance"
							class="form-control" disabled>
					</div>
