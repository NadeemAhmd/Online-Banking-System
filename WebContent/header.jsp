		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav js-nav-add-active-class">
					...
					%>
					<li><a href="check_balance.jsp">Check Balance</a>
							...
							<li>
								<div class="navbar-login">
									<div class="row">
										...
										<div class="col-md-8">
											<p class="text-left">
												<strong>Name:</strong> <%=ac.getFirst_name() + " " + ac.getLast_name()%>
											</p>
											<p class="text-left">
												<strong>Account No:</strong><%=ac.getAccount_no() %>
											</p>
											<p class="text-left small"><strong>Email:</strong><%=ac.getEmail()%>
											</p>
											<p class="text-left">
												<a href="profile.jsp"
